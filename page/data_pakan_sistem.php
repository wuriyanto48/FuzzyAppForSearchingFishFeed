                    ...
                    <div class="block">
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            for ($i = 0; $i < count($list_pakan); $i++) {
                                ...
                                echo "<tr><td><img src='ambil_gambar_pakan.php?kode_pakan=$kode_pakan&token=$token' width='40' height='30'/></td><td>$kode_tipe</td><td>$nama_pakan</td><td>$harga</td>"
                                . "<td><a href='data_pakan_detail_by_user.php?kode_pakan=$kode_pakan&token=$token' class='btn-icon btn-teal btn-check' target='blank'><span></span>Detail</a></td></tr>";
                            ...
                            if ($pages > 1) {
                                ...
                                for ($i = 1; $i <= $pages; $i++) {
                                    if ($i != ceil($start / $batch)) {
                                        echo " <a href='data_pakan_sistem.php?page=$i' class='btn btn-teal'>$i</a> ";
                                    } else {
                                        echo " <a href='#' class='btn btn-teal'>$i</a> ";
                                    }
                                }
                                echo '</td>';
                                echo '</tr>';
