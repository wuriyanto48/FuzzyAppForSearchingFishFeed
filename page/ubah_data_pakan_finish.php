...
if (isset($_POST['Simpan'])) {
    ...
    $pd->update($kode_pakan, $tipe_pakan, $nama_pakan, $harga);
    $pdd->update($kode_pakan, $bobot_kadar_air, $bobot_protein, $bobot_lemak, $bobot_serat_kasar, $bobot_kadar_abu);
    $pgd->update($kode_pakan, $gambar_pakan);
